 ...
 */
- (instancetype)initWithFrame:(CGRect)frame delegate:(id<SGPageTitleViewDelegate>)delegate titleNames:(NSArray<NSString *> *)titleNames configure:(SGPageTitleViewConfigure *)configure;
/**
 ...
 *  @param configure        SGPageTitleView 信息配置
 */
+ (instancetype)pageTitleViewWithFrame:(CGRect)frame delegate:(id<SGPageTitleViewDelegate>)delegate titleNames:(NSArray<NSString *> *)titleNames configure:(SGPageTitleViewConfigure *)configure;
